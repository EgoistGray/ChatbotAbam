...
class Encharten {
    constructor() {
        ...
        this.messageHeader = `Jadwal PH selama satu semester: \n`;
        this.messageFooter = `\n\nSekretarismu...  ♥`
    ...
    _processSchedule() {
        ...
        schedule_construct = schedule_construct.flat().join('\n');
        schedule_construct = this.messageHeader + schedule_construct + this.messageFooter;

        return schedule_construct.length !== 0 ? schedule_construct : this.noWork;
    }
